            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Administrative">
                        ...
                        <li
                            ...
                            <a href="#"
                                class="nav-link {{ in_array(Route::currentRouteName(), ['payments.index', 'payments.edit', 'payments.create', 'payments.manage', 'payments.show', 'payments.invoice']) ? 'active' : '' }}">Fees</a>

                            <ul class="nav nav-group-sub">
                                <li class="nav-item"><a href="{{ route('payments.create') }}"
                                        class="nav-link {{ Route::is('payments.create') ? 'active' : '' }}">Create
                                        Fee</a></li>
                                <li class="nav-item"><a href="{{ route('payments.showOptions') }}"
                                        class="nav-link ">Occasional Fee</a></li>
                ...
                <li
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Manage Students">
                        <li class="nav-item">
                            <a href="{{ route('students.create') }}" class="nav-link ">Add Applicant</a>
                        </li>
                        <li class="nav-item }}">
                            <a href="{{route('applicants.list')}}" class="nav-link ">Applicant Information</a>
                        </li>
                        <li class="nav-item"><a href="{{ route('applicants.meritList.options') }}"
                                class="nav-link ">Combination-Wise Merit List</a></li>
                        <li class="nav-item"><a href="{{ route('applicants.meritListGroup.options') }}"
                                class="nav-link ">Group-Wise Merit List</a></li>
                        <li class="nav-item"><a href="{{ route('applicants.getChallan') }}" class="nav-link ">Generate
                                Challan</a></li>
                        <li class="nav-item">
                            <a href="{{ route('applicants.admitApplicant') }}" class="nav-link ">Admit Applicant</a>
                        </li>
                    </ul>
                </li>
                {{--Manage Students--}}
                <li
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Manage Students">
                        ...
                        @if(Qs::userIsTeamSA())
                        <li class="nav-item">
                            <a href="{{ route('students.addApplicant') }}" class="nav-link {{ (Route::is('students.addApplicant')) ? 'active' : '' }}">Admit Applicant</a>
                        </li>
                        @endif -->
                        <li class="nav-item }}">
                            <a href="{{route('students.readmitStudent')}}" class="nav-link ">Re-Admit Student</a>
                        </li>
                        <li>
                            <a href="{{route('students.change_combination')}}" class="nav-link">Change Group</a>
                        </li>
                        <li>
                            <a href="{{route('students.show_allot_sections')}}" class="nav-link">Allot Sections</a>
                        </li>
                        {{--Student Information--}}
                        <li
                ...
                <li class="nav-item nav-item-submenu">
                    <a href="#" class="nav-link"><i class="icon-users"></i> <span>Reports</span></a>
                    <ul class="nav nav-group-sub" data-submenu-title="Manage Reports">
                        <li class="nav-item"><a href="{{ route('applicants.totalApplicants') }}" class="nav-link ">Total
                                Applicants</a></li>
                        <li class="nav-item"><a href="{{ route('students.totalAdmissions') }}" class="nav-link ">Total
                                Admissions</a></li>
                        <li class="nav-item"><a href="{{ route('students.section_list') }}" class="nav-link ">Student
                                Lists</a></li>
                        <li class="nav-item"><a href="{{ route('students.byAge') }}" class="nav-link ">Students By
                                Age</a></li>
                        <li class="nav-item"><a href="{{ route('students.attendance.report.options') }}"
                                class="nav-link ">Student Wise
                                Attendance</a></li>
                        <li class="nav-item"><a href="{{ route('students.attendance.monthly.report.options') }}"
                                class="nav-link ">Monthly Attendance Report</a></li>
                    </ul>
                </li>
                <!-- @if(Qs::userIsTeamSA())
                {{--Manage Users--}}
                ...
                <li class="nav-item nav-item-submenu">
                    <a href="#" class="nav-link"><i class="icon-users"></i> <span>Attendance</span></a>
                    <ul class="nav nav-group-sub" data-submenu-title="Manage Reports">
                        <li class="nav-item"><a href="{{ route('students.attendance') }}" class="nav-link ">Add
                                Attendance</a></li>
                        <li class="nav-item"><a href="{{ route('students.attendance.view.options') }}"
                                class="nav-link ">View Attendance</a></li>
                        <li class="nav-item"><a href="{{ route('students.attendance.update.options') }}"
                                class="nav-link ">Update Attendance</a></li>
                        <!-- <li class="nav-item"><a href="{{ route('students.section_list') }}" class="nav-link ">Student Lists</a></li>
                        <li class="nav-item"><a href="{{ route('students.byAge') }}" class="nav-link ">Students By Age</a></li> -->
                    </ul>
                </li>
                <!-- <li class="nav-item">
                    <a href="{{ route('students.attendance') }}" class="nav-link {{ in_array(Route::currentRouteName(),['students.attendance']) ? 'active' : '' }}"><i class="icon-fence"></i> <span>Attendance</span></a>
                </li> -->
                <!-- {{--Manage Subjects--}}
                @endif -->
