                    ...
                    <h6>Personal Data</h6>
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                <div class="form-group">
                                        <label for="user_type"> Designation: <span class="text-danger">*</span></label>
                                        <select required data-placeholder="Select Designation" class="form-control select" name="designation" id="designation">
                                @foreach($designation as $ut)
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Phone:</label>
                                        <input value="{{ old('phone') }}" type="text" name="phone" class="form-control" placeholder="+2341234567" required>
                                    </div>
                                </div>
