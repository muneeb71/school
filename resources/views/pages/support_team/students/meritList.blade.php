...
<div class="card">
    ...
    <form id="" method="post" enctype="multipart/form-data" class="wizard-form steps-validation" action="{{ route('applicants.meritList.generate') }}" data-fouc>
        @csrf
        <h6></h6>
        <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <select onchange="grpChange()" id="group_id" data-placeholder="Choose..." required name="group_name" id="group_id" class="select-search form-control" required>
                                    <option value=""></option>
