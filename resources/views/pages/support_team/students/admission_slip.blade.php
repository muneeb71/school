        ...
        <div style="margin:20px;border-radius:10px;border:3px solid black;">
            ...
            <div class="row" style="padding:0 20px;padding-bottom:20px">
                ...
                <div class="col-md-6">
                    ...
                    <div style="display: flex;align-items: center;">
                        <h6 style="text-decoration: underline;padding-right:10px">Rs. </h6>
                        <input type="number" id="paid_fees" value="{{ $paid }}" name="paid_fee" class="form-control" placeholder="Paid Fee" onchange="calBalance()" onblur="copyFee()" required>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div style="display: flex;align-items: center;">
                        <h6 style="text-decoration: underline;padding-right:10px">Rs. </h6>
                        <input type="number" id="balance" value="{{ $balance }}" name="balance" class="form-control" placeholder="Balance" readonly>
                    </div>
                </div>
        ...
        <div style="margin:20px;border-radius:10px;border:3px solid black;">
            ...
            <div class="row" style="padding:0 20px;padding-bottom:20px">
                ...
                <div class="col-md-6">
                    ...
                    <div style="display: flex;align-items: center;">
                        <h6 style="text-decoration: underline;padding-right:10px">Rs. </h6>
                        <input type="number" id="paid_fees1" value="{{ $paid }}" name="paid_fee" class="form-control" placeholder="Paid Fee" onchange="calBalance()" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <h6 style="text-decoration: underline;">Balance: </h6>
                    <div style="display: flex;align-items: center;">
                        <h6 style="text-decoration: underline;padding-right:10px">Rs. </h6>
                        <input type="number" id="balance1" value="{{ $balance }}" name="balance" class="form-control" placeholder="Balance" readonly>
                    </div>
                </div>
                <div class="form-btns col-md-6" style="text-align: right;">
                    <button class="btn btn-primary" type="submit">Save</button>
