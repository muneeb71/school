                    ...
                    <div class="section-to-print" style="min-width: 98vw;max-width: 100vw;">
                        ...
                        <div style="display: flex;flex-wrap: nowrap;justify-content: center;width:fit-content">
                            <div class="main_form_cont" style="border: 2px dashed black;padding:10px">
                                ...
                                <div class="row">
                                    <span style="width: 90%; border: none;padding: 20px 0;"><b>Due Date: {{$date['description']}}</b></span>
                                </div>
                                ...
                                <div>
                                    <div style="display: flex;padding:20px 20px;justify-content: space-between;">
                                        <div><span><b>Receipt#:</b> {{$applicants->form_no}}</span></div>
                                ...
                                <div style="
                                    ...
                                    <div style="                                            
                                        ...
                                        ">
                                        <div>
                                            <span style="font-weight: bold">Class: </span>{{$class->name}}
                                        </div>
                                        <div>
                                            <span style="font-weight: bold">Form: </span>{{$applicants->form_no}}
                                        </div>
                                    </div>
                                    <hr />
                                    <div>
                                        <span style="font-weight: bold">Name</span>: {{$applicants->name}}
                                    </div>
                                    <hr />
                                    <div>
                                        <span style="font-weight: bold">F.Name</span>: {{$applicants->fathers_name}}
                                    </div>
                                    <hr />
                                    
                                    <div>
                                        <span style="font-weight: bold">Group</span>: {{$applicants->group_name}}
                                    </div>
                                    <hr />
                                    <div>
                                        <span style="font-weight: bold">Combination</span>: {{$applicants->subject_combination}}
                                    </div>
                                    <hr />
                                    <div>
                                        <span style="font-weight: bold">Session: </span>{{$applicants->session}}
                                    </div>
                                </div>
                                <div style="border:2px solid black;padding-bottom:80px;border-radius:10px;padding-left:10px;padding-right:10px;margin-top:20px">
                                    ...
                                    <div class="desc-wrappers">
                                        ...
                                        ">
                                                <img class="barcode" />
                                                <Strong style="font-size: 18px;">Total Payable: <?php echo $i ?>.0</Strong>
                                            </span>
                                        </div>
                                    </div>
                                </div>
