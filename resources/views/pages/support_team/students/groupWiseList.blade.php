...
<div class="card" style="border:2px solid black">
    ...
    <div class="card-header" style="width: 80%;margin:auto">
        <div style="display: flex;justify-content: space-around;">
            <h4 class="card-title" style="font-weight:bold">Class : {{$group}}</h4>
            <!--<h4 class="card-title">Group : ARTS</h4>-->
           
            <h4 class="card-title" style="font-weight:bold">Session: {{$session}}</h4>
        </div>
        <br>
        <div style="display: flex;justify-content: space-around;">
            <h4 class="card-title" style="font-weight:bold">Section : {{$section}}</h4>
        </div>
        <br>
