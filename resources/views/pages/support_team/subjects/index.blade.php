                        ...
                        <div class="col-md-6">
                            <form class="" method="post" action="{{ route('subjects.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="section" name="section" value="{{ old('section') }}" required type="text" class="form-control" placeholder="Section">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="combination" class="col-lg-3 col-form-label font-weight-semibold">Select Combination <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <select data-placeholder="Select Combination" class="form-control select" name="combination" id="combination">
                                            <option value=""></option>
