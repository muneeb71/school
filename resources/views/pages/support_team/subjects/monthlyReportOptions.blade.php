...
<div class="card">
    <div class="card-header bg-white header-elements-inline">
        <h6 class="card-title">Please Select Options For Monthly Report</h6>
    ...
    <form id="" method="post" enctype="multipart/form-data" class="wizard-form steps-validation"
        action="{{ route('students.attendance.monthly.report.generate') }}" data-fouc>
        @csrf
        <h6></h6>
        <fieldset>
            <div style="margin-bottom: 20px;">
                ...
                <div class="personal-data">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="quota_id">Combination: <span class="text-danger">*</span></label>
                                <select data-placeholder="Choose..."  name="combination" id="combination"
                                    class="select-search form-control" >
                                    <option value=""></option>
                                    @foreach($combinations as $nal)
                                    <option {{ (old('nal_id') == $nal->id ? 'selected' : '') }} value="{{$nal->name}}">
                                        {{ $nal->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>From:</label>
                                <input name="from" value="{{ old('from') }}" type="text" class="form-control date-pick"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>To:</label>
                                <input name="to" value="{{ old('to') }}" type="text" class="form-control date-pick"
