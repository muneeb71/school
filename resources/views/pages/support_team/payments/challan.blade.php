                ...
                <div id="ChallanDiv">
                    ...
                    <div class="section-to-print" style="min-width: 98vw;max-width: 100vw;">
                        ...
                        <div style="width:100%;display: flex;justify-content: center;">
                            <div class="main_form_cont" style="border: 2px solid black">
                                <div class="row">
                                    <span style="
                                            width: 97.5%;
                                            text-align: center;
                                ...
                                <div class="row">
                                    <span style="width: 90%; border: none;padding: 20px 0;"><b>Due Date: {{$applicants['date']['description']}}</b></span>
                                </div>
                                ...
                                <div>
                                    <div style="display: flex;padding:20px 20px;justify-content: space-between;">
                                        <div><span><b>Receipt#:</b> {{$app->form_no}}</span></div>
                                ...
                                <div style="
                                    ...
                                    <div style="                                            
                                        ...
                                        ">
                                        <div>
                                            <span style="font-weight: bold">Class: </span>Yet To be Alloted
                                        </div>
                                        <div>
                                            <span style="font-weight: bold">Roll No: </span>Yet To be Alloted
                                        </div>
                                    </div>
                                    <hr />
                                    <div>
                                        <span style="font-weight: bold">Name</span>: {{$app->name}}
                                    </div>
                                    <hr />
                                    <div>
                                        <span style="font-weight: bold">F.Name</span>: {{$app->fathers_name}}
                                    </div>
                                    <hr />
                                    <div>
                                        <span style="font-weight: bold">Session: </span>{{$app->session}}
                                    </div>
                                </div>
                                <div style="display: flex;justify-content: space-between;padding: 10px 20px;border: 1px solid black;border-right:0;border-left:0">
                                    <div></div>
