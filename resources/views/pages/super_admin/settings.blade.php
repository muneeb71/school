        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 border-right-2 border-right-blue-400">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Fees Due Date</label>
                            <div class="col-lg-6">
                                <input name="Due_date" value="{{ $s['Due_date'] }}" type="text" class="form-control date-pick" placeholder="Due Date">
                            </div>
                            <div class="col-lg-3 mt-2">
                                <span class="font-weight-bold font-italic">M-D-Y or M/D/Y </span>
                            </div>
